...
import { Search, Filter, Heart, Verified, DollarSign, ArrowRight, Dog, Cat, AlertCircle } from "lucide-react";
...
const RehomingList: React.FC = () => {
  ...
  // Fetch pets data
  const fetchPets = useCallback(async (appliedFilters: RehomingFilters = {}) => {
    try {
      setLoading(true);
      setError("");
      ...
      console.log("🏠 Fetching rehoming pets with filters:", searchFilters);
      ...
      console.log("✅ Fetched rehoming pets:", result.pets.length);
    } catch (err: unknown) {
      console.error("❌ Failed to fetch rehoming pets:", err);
  ...
  const handleFilterChange = (key: keyof RehomingFilters, value: string | number | undefined) => {
      ...
      <div className="max-w-7xl mx-auto px-4 py-6">
        ...
        <div className="flex items-center justify-between">
          ...
          <Button
            ...
            className="bg-gradient-to-r from-green-600 to-emerald-700 hover:from-green-700 hover:to-emerald-800 text-white font-semibold px-6"
          >
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
                    ...
                    <div>
                      ...
                      <select
                        ...
                        onChange={(e) => handleFilterChange("adoptionType", e.target.value || undefined)}
                        className="w-full bg-gray-800 border border-gray-700 rounded-lg px-3 py-2 text-white"
                      >
          ...
          <Card className="border-0 shadow-lg bg-gradient-to-br from-gray-900 via-gray-800 to-gray-900 max-w-md mx-auto">
            <CardContent className="p-8 text-center">
              ...
              <p className="text-gray-300 mb-4">
                {searchTerm || Object.keys(filters).some(key => filters[key as keyof RehomingFilters] !== undefined && key !== 'page' && key !== 'limit')
                  ...
                  <CardContent className="p-0">
                    ...
                    <div className="aspect-square relative overflow-hidden rounded-t-lg">
                      {pet.imageUrls && pet.imageUrls.length > 0 ? (
                        <img
                          src={pet.imageUrls[0] || "https://img.freepik.com/free-photo/cute-pet-collage-isolated_23-2150007407.jpg?semt=ais_hybrid&w=740&q=80"}
                          alt={pet.name}
                          className="w-full h-full object-cover group-hover:scale-105 transition-transform duration-300"
                          loading="lazy"
                          onError={(e) => {
                            (e.currentTarget as HTMLImageElement).src = "https://img.freepik.com/free-photo/cute-pet-collage-isolated_23-2150007407.jpg?semt=ais_hybrid&w=740&q=80";
                          }}
                        />
                      ) : (
